...
public class AppiumChromeBrowserDriverProvider extends AppiumDriverProvider implements DriverProvider {
	...
	public boolean canCreateDriverInstanceFor(Capabilities capabilities) {
	    return "chrome".equals(capabilities.getBrowserName()) && "android".equals(capabilities.getCapability(MobileCapabilityType.PLATFORM_NAME));
	}
