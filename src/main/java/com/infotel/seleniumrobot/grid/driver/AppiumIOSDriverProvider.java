...
public class AppiumIOSDriverProvider extends AppiumDriverProvider implements DriverProvider {
	...
	public boolean canCreateDriverInstanceFor(Capabilities capabilities) {
	    return "ios".equals(capabilities.getCapability(MobileCapabilityType.PLATFORM_NAME));
	}
