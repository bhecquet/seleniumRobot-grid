...
public class RelaySessionFactoryActions {
    ...
    public Object onTest(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        System.out.println("test: " + requestedCapabilities);
        System.out.println("vs stereotype: " + ((RelaySessionFactory) joinPoint.getTarget()).getStereotype());
        ...
        Object testReply = joinPoint.proceed(new Object[]{requestedCapabilities});
        System.out.println("test => " + testReply);
        return testReply;
    }
    ...
    public Object onApply(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            if (platformName != null && platformName.is(Platform.ANDROID)) {
                ...
                updatedCapabilities = mobileDeviceSelector.updateCapabilitiesWithSelectedDevice(new MutableCapabilities(capabilities), DriverMode.LOCAL, LaunchConfig.getCurrentLaunchConfig().doUseSeleniumManager());
