...
public class TestLaunchConfig {
    ...
    public void testNodeRole() throws IOException {
        ...
        Assert.assertTrue(config.doCleanBrowserProfile());
    ...
    @Test(groups = {"grid"})
    public void testSetCleanBrowserProfile() {
        LaunchConfig config = new LaunchConfig(new String[]{"node", "--cleanBrowserProfiles", "true"});
        Assert.assertTrue(config.doCleanBrowserProfile());
    }
