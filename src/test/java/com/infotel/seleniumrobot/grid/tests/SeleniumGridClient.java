...
public class SeleniumGridClient {
	...
	public static void main(String [] args) throws IOException {
		...
		capability.setCapability(CapabilityType.BROWSER_NAME, "iexplore");
//		capability.setCapability(SeleniumRobotCapabilityType.BETA_BROWSER, true);
...
//		capability.setCapability(MobileCapabilityType.DEVICE_NAME, "Google Nexus 6 - 6.0.0 - API 23 - 1440x2560");
		...
		WebDriver driver = new RemoteWebDriver(new URL("http://pp20061968:4444/wd/hub"), capability);
		driver.quit();
	}
}
