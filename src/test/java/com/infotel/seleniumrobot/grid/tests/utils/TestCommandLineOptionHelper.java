...
public class TestCommandLineOptionHelper {
	...
	public void testIsPresent() {
		CommandLineOptionHelper cmd = new CommandLineOptionHelper(new String[] {"-role", "node"});
	...
	public void testGetParamNoValue() {
		CommandLineOptionHelper cmd = new CommandLineOptionHelper(new String[] {"-role"});
	...
	public void testGetParamValues() {
		CommandLineOptionHelper cmd = new CommandLineOptionHelper(new String[] {"-role", "node,hub"});
	...
	public void testGetAllParams() {
		CommandLineOptionHelper cmd = new CommandLineOptionHelper(new String[] {"-role", "node", "-role", "hub"});
		Assert.assertEquals(cmd.getAll("-role"), Arrays.asList("node", "hub"));
	}
	
	@Test(groups={"grid"})
	public void testRemoveAllParams() {
		CommandLineOptionHelper cmd = new CommandLineOptionHelper(new String[] {"-role", "node", "-conf", "myConf", "-role", "hub"});
		Assert.assertEquals(cmd.removeAll("-role"), Arrays.asList("-conf", "myConf"));
	}
	
	@Test(groups={"grid"})
	public void testGetKeys() {
		CommandLineOptionHelper cmd = new CommandLineOptionHelper(new String[] {"-role", "node", "-conf", "myConf"});
